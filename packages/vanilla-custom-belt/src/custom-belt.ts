import { BeltProps, StripePosition, DefaultColor } from '../../custom-belt-lib/src/Belt.ts';

export class VanillaBeltSystem {
  element: HTMLElement;
  beltProps: BeltProps[];
  ...
  constructor(element: HTMLElement, beltProps: BeltProps[]) {
    ...
    const svgString = this.getSVGString(beltProps[0]);
  ...
  hasPatch = () => {
    if (this.beltProps === undefined) {
      return '';
    }
    return `style='visibility: ${this.beltProps.hasPatch ? 'visible' : 'hidden'};'`;
  };
  ...
  hasProfessorPatch = (): string => {
    ...
    return `style='visibility: ${this.beltProps.hasProfessorPatch ? 'visible' : 'hidden'}';`;
  };
  ...
  patchColor = (): string => {
    ...
    return `style='fill: ${this.beltProps.patch}; ${this.additionalStyles()}'`;
  };
  ...
  patchBorderColor = (): string => {
    ...
    return `style='fill: ${this.beltProps.patchBorder}; ${this.additionalStyles()}'`;
  };
  ...
  professorPatchColor = (): string => {
    ...
    return `style='fill: ${this.beltProps.professorPatch}; ${this.additionalStyles()}'`;
  };
  ...
  getStripeIndex = (stripeCount: number): number => {
    ...
    if (this.beltProps.stripePosition === StripePosition.length) {
      return stripeCount;
    } else {
  ...
  stripeStyle = (stripeCount: number, fillColor: string) => {
    ...
    return `style='fill: ${fillColor}; ${this.additionalStyles()} visibility: ${
      this.beltProps.stripeCount > 0 && this.beltProps.stripeCount >= stripeCount
        ? 'visible'
        : 'hidden'
    };'`;
  };
  ...
  stripe = (stripeCount: number) => {
    ...
    switch (stripeCount) {
      case 1:
        fillColor = this.beltProps.stripe1;
        break;
      case 2:
        fillColor = this.beltProps.stripe2;
        break;
      case 3:
        fillColor = this.beltProps.stripe3;
        break;
      case 4:
        fillColor = this.beltProps.stripe4;
        break;
      case 5:
        fillColor = this.beltProps.stripe5;
        break;
      case 6:
        fillColor = this.beltProps.stripe6;
        break;
      case 7:
        fillColor = this.beltProps.stripe7;
        break;
      case 8:
        fillColor = this.beltProps.stripe8;
        break;
      case 9:
        fillColor = this.beltProps.stripe9;
        break;
      case 10:
        fillColor = this.beltProps.stripe10;
        break;
      default:
  ...
  transition = () => {
    ...
    if (!this.beltProps.transitionCSS) return '';
    else return `${this.beltProps.transitionCSS};`;
  };
  ...
  getSVGString = (beltProp: BeltProps): string => {
    const svgString = `<svg
    id=""
