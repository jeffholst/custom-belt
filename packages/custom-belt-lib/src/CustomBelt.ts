...
export interface CustomBeltInit {
  ...
  beltProps: BeltProps[];
  beltAttributes: BeltAttributes | null;
}
...
export const getCustomBeltInit = (
  ...
  beltProps: BeltProps[],
  beltAttributes: BeltAttributes | null = null
): CustomBeltInit => {
...
export class CustomBelt {
   ...
   */
  constructor(customBeltInit: CustomBeltInit, beltAttributes: BeltAttributes | null = null) {
    this.customBeltInit = customBeltInit;
    if (beltAttributes) {
      this.beltAttributes = beltAttributes;
    } else {
      this.beltAttributes = getBeltAttributes();
    }
  ...
  getColor = (hexColor: string) => {
    ...
    const result = `style='${this.getColorInner(hexColor)}'`;

    return result;
  };

  getColorInner = (hexColor: string) => {
    if (hexColor === undefined) {
      return '';
    }
    const result = `fill: ${hexColor}; ${this.additionalStyles()}`;

    return result;
  };

  getId = (elementNumber: number, id: string) => {
    return `${this.beltAttributes.id}_${elementNumber}_${id}`;
  };
  ...
  getSVGString = (elementNumber: number): string => {
    if (this.currentBelt === null || this.currentBelt === undefined) {
      return '';
    }
  ...
  >
    <g id="${this.getId(elementNumber, 'KnotBend3')}">
      <path
        id="${this.getId(elementNumber, 's7l3BendColor')}"
        d="m169.7,34.3s-1.5,5,.2,7.4,24.9,1.8,24.9,1.8l-11.3-10.2-13.8,1h0Z"
        ${this.getColor(this.currentBelt.s7l3Color)}
      />
      <path
        id="${this.getId(elementNumber, 'border8')}"
    ...
    <g id="${this.getId(elementNumber, 'KnotBend2')}">
      <path
        id="${this.getId(elementNumber, 's2l3BendColor')}"
      ...
      />
      <path
        id="${this.getId(elementNumber, 'border7')}"
    ...
    <g id="${this.getId(elementNumber, 'KnotBend1')}">
      <path
        id="${this.getId(elementNumber, 's1l3BendColor')}"
        d="m238.9,14.7s-5.3-1.9-14.1,8.5c-8.9,10.3,15.1,8.2,15.1,8.2l-.9-16.7h-.1Z"
        ${this.getColor(this.currentBelt.s1l3Color)}
      />
      <path
        id="${this.getId(elementNumber, 'border6')}"
    ...
    <g id="${this.getId(elementNumber, 'BeltWaist')}">
      <g id="${this.getId(elementNumber, 'section13')}">
        <path
          id="${this.getId(elementNumber, 's13l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's13l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's13l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's13l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section12')}">
        <path
          id="${this.getId(elementNumber, 's12l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's12l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's12l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's12l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section11')}">
        <path
          id="${this.getId(elementNumber, 's11l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's11l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's11l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's11l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section10')}">
        <path
          id="${this.getId(elementNumber, 's10l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's10l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's10l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's10l1Color')}"
      ...
      <path
        id="${this.getId(elementNumber, 'border5')}"
    ...
    <g id="${this.getId(elementNumber, 'BeltRight')}">
      <g id="${this.getId(elementNumber, 'section9')}">
        <path
          id="${this.getId(elementNumber, 's9l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's9l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's9l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's9l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section8')}">
        <path
          id="${this.getId(elementNumber, 's8l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's8l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's8l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's8l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section7')}">
        <path
          id="${this.getId(elementNumber, 's7l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's7l2bColor')}"
      ...
      <g id="${this.getId(elementNumber, 'border4')}">
        <path
    ...
    <g id="${this.getId(elementNumber, 'BeltKnotBottom')}">
      <g id="${this.getId(elementNumber, 'section6')}">
        <path
          id="${this.getId(elementNumber, 's6l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's6l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's6l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's6l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section5')}">
        <path
          id="${this.getId(elementNumber, 's5l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's5l2bColor')}"
      ...
      <g id="${this.getId(elementNumber, 'border3')}">
        <path
    ...
    <g id="${this.getId(elementNumber, 'BeltLeft')}">
      <g id="${this.getId(elementNumber, 'section4')}">
        <path
          id="${this.getId(elementNumber, 's4l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's4l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's4l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's4l1Color')}"
      ...
      <g id="${this.getId(elementNumber, 'section3')}">
        <path
          id="${this.getId(elementNumber, 's3l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's3l2bColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's3l3Color')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's3l1Color')}"
      ...
      <path
        id="${this.getId(elementNumber, 'border2')}"
    ...
    <g id="${this.getId(elementNumber, 'BeltKnotCenter')}">
      <g id="${this.getId(elementNumber, 'section2')}">
        <path
          id="${this.getId(elementNumber, 's2l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's2l2bColor')}"
      ...
      <g id="${this.getId(elementNumber, 'section1')}">
        <path
          id="${this.getId(elementNumber, 's1l2aColor')}"
        ...
        />
        <path
          id="${this.getId(elementNumber, 's1l2bColor')}"
      ...
      <g id="${this.getId(elementNumber, 'border1')}">
        <path
  ...
  initElements = (): Array<HTMLElement> => {
    ...
    elements.forEach((e) => {
      this.svgString =
        this.currentBelt != null ? this.getSVGString(elementNumber) : 'Invalid beltParms received';
  ...
  refreshElements = (): void => {
    ...
    this.elements.forEach((e) => {
      BeltShapeIds.forEach((id) => {
        ...
        if (element != null && this.currentBelt != null) {
          const newStyle = this.getColorInner(this.currentBelt[id]);
          element.setAttribute('style', newStyle);
        }
      });
      if (this.currentBelt != null) {
        myId = this.getId(elementNumber, 's7l3BendColor');
        document
          .getElementById(myId)
          ?.setAttribute('style', this.getColorInner(this.currentBelt['s7l3Color']));
        myId = this.getId(elementNumber, 's2l3BendColor');
        document
          .getElementById(myId)
          ?.setAttribute('style', this.getColorInner(this.currentBelt['s2l3Color']));
        myId = this.getId(elementNumber, 's1l3BendColor');
        document
          .getElementById(myId)
          ?.setAttribute('style', this.getColorInner(this.currentBelt['s1l3Color']));
      }
      elementNumber++;
    });
  };
